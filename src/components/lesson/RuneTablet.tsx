...
export const RuneTablet = ({ hotkeys, topClass = "top-16" }: RuneTabletProps) => {
  if (!hotkeys || hotkeys.length === 0) return null;

  return (
    <div className={`sticky ${topClass} z-40 w-full bg-void/95 border-b border-amber-900/30 backdrop-blur-sm`}>
